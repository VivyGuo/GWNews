...
{
    return [GWDate stringFromDate:date formater:&s_formatterYMD format:YMDFormat];
}

+ (NSDate *)dateFromStringYMD:(NSString *)dateString
{
    return [GWDate dateFromString:dateString formater:&s_formatterYMD format:YMDFormat];
}

+ (NSString *)stringFromDateYMDEHM:(NSDate *)date
{
    return [GWDate stringFromDate:date formater:&s_formatterYMDEHM format:YMDEHMFormat];
}

+ (NSDate *)dateFromStringYMDEHM:(NSString *)dateString
{
    return [GWDate dateFromString:dateString formater:&s_formatterYMDEHM format:YMDEHMFormat];
}

+ (NSString *)stringFromDateYMDHMS:(NSDate *)date
{
    return [GWDate stringFromDate:date formater:&s_formatterYMDHMS format:YMDHMSFormat];
}

+ (NSDate *)dateFromStringYMDHMS:(NSString *)dateString
{
    return [GWDate dateFromString:dateString formater:&s_formatterYMDHMS format:YMDHMSFormat];
}
