//  Created by hejinbo on 13-4-24.
//  Copyright (c) 2013年 KingCloud. All rights reserved.
//

#import "GWString.h"

@implementation GWString

static char gwTwoCharToHex(char a, char b)
{
...
+ (void)convertString:(NSString *)source toHexBytes:(unsigned char *)hexBuffer
{
    ...
    while ((*bytes) && (*(bytes +1))) {
        *index = gwTwoCharToHex(*bytes, *(bytes + 1));
